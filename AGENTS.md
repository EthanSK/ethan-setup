...
- Website changes include Pages publication, a successful deployment check and verification of the exact live cache-versioned assets. After publication, leave Chrome on the verified public URL; a cached localhost room can outlive its preview server and leave lazy-loaded models unavailable. Check an uncached model request before handing off any local preview. Keep native apps, live OBS recording, unrelated worktrees and user browser windows untouched.
