...
The Dell room hotspot opens its rotatable monitor model, specs and product link. A separate nearby Codex hotspot opens the full-height desktop embed; do not route the Dell product click to that website again. The Samsung hotspot opens the OBS demo, with its model and Open screen action available in the Hardware directory. Do not reintroduce duplicate headings, subtitles or a Desktop / 3D monitor toolbar above the embedded screen. Keep its accessible name, close control and outside-click dismissal.
